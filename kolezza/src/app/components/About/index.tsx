    ...
    <div id='about' className="px-7 md:px-8 lg:px-32">
      ...
      <div className='flex flex-col lg:flex-row gap-8 lg:gap-28'>
        <div className='mt-8 lg:mt-16'>
          ...
          <div className='block lg:hidden w-full h-auto mb-8'>
            <Image
              src="/images/parent.avif"
              alt="parents image"
              width={549}  
              height={748} 
          ...
          <div className='hidden lg:block w-[549px] l-[748px] lg:w-[427px] h-auto mt-16 lg:mt-20 lg:ml-14'>
            <Image
              src="/images/parent.avif"
              alt="parents image"
              width={427}  
        ...
        <div className='mt-10 lg:mt-10'>
          <div className='w-full lg:w-[427px] h-auto ml-0 lg:ml-14 md:float-start'>
            <Image
