...
const HowSawaTokWorks = () => {
  return (
    <section id='product' className="py-14 px-10 md:px-16 lg:px-24 xl:px-3 lg:pt-66">
      <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl text-customDarkBlue font-bold text-center drop-shadow-[3px_3px_6px_rgba(0,0,0,0.5)]">
        How SawaTok Works
      </h2>
      <div className="flex flex-col md:flex-row gap-0 md:gap-8 items-center justify-center md:mt-22 mx-4">
        <div className="flex-1 border-l-8 border-customDarkBlue pl-4 md:mb-0 md:mr-10 xl:ml-36 mb-24 mt-8 md:mt-32">
          <p className="text-[16px] sm:text-[20px] md:text-[24px] lg:text-[28px] xl:text-[32px] font-normal leading-relaxed">
        ...
        <div className="flex justify-center flex-1 mb-10 md:mb-6 items-center">
          <motion.div
...
export default HowSawaTokWorks;